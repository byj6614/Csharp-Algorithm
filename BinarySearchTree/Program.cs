namespace BinarySearchTree
{
    internal class Program
    {
		...
		//<트리기반의 자료구조의 순회>
		//트리기반의 자료구조에 순회순서에 대해서 알아볼 필요가 있다
		//1. 전위순회 : 노드, 왼쪽, 오른쪽
		//2. 중위순회 : 왼족, 노드, 오른쪽  <--이진탐색트리의 순회 : 오름차순 정렬
		//3. 후위순회 : 왼쪽, 오른쪽, 노드
        void BinarySearchTree()
		{
			...
			Monster monster;
			sortedDic.TryGetValue("파이리", out monster);			//파이리 탐색 새도
			Monster indexMonster = sortedDic["파이리"];                //인덱서를 통한 탐색
